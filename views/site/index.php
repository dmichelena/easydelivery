...
<div class="col-md-4 column">
    <div class="usuario-form">
        ...
        <?= $form->field($model, 'dni', ['labelOptions'=>['class'=>'control-label col-md-3 dni']])->textInput(['maxlength' => 8]) ?>
        <div class=\"col-md-offset-2 col-md-10\"><?= \yii\helpers\Html::buttonInput('Buscar', ['class' => 'btn btn-warning buscar']) ?></div>

        <?= $form->field($model, 'nombre', ['labelOptions'=>['class'=>'control-label col-md-3 nombre']])->textInput(['maxlength' => 45]) ?>
